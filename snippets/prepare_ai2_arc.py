...
def prepare(
    destination_path: Path = Path("data/ai2_arc"),
    test_split_fraction: float = 0.1,
    checkpoint_dir: Path = Path("checkpoints/stabilityai/stablelm-base-alpha-3b"),
    mask_inputs: bool = False,  # as in alpaca-lora
    seed: int = 42,
    data_repo_id: str = "ai2_arc",
    ignore_index: int = -1,
    ...
    misc_dataset = load_dataset(data_repo_id, "ARC-Challenge", split="train", use_auth_token=access_token)
